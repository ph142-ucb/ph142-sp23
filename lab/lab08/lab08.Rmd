...
### Instructions 
* Due date: Tuesday, April 4th, at 10:00pm PST with 2 hour grace period.
...
dominant_num_dots_hit <- NULL # YOUR CODE HERE
non_dominant_num_dots_hit <- NULL # YOUR CODE HERE
dominant_hand_first <- NULL # YOUR CODE HERE - TRUE/FALSE
Student_name <- NULL # YOUR CODE HERE - Name as a 'string'

our_sheet <- rbind(our_sheet, list(dominant_num_dots_hit, non_dominant_num_dots_hit, dominant_hand_first, Student_name))
our_sheet
```
...
cd; cd ph142-sp23/lab/lab08; python3 turn_in.py
